...
test("legacy SQLite source edits migrate to Formula schema 6 and support undo", () => {
...
test("Rhai source edits migrate to schema 6 and preserve ordered output columns", () => {
